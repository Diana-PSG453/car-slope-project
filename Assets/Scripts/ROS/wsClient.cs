...
{
    public enum advertiseTorque{
        Yes,
        No
    }

    public enum advertiseAngularVelocities{
        Yes,
        No
    }
    ...
    private void Start()
    {
        ...
        //if true advertise toruqeTopic
        advertiseTopic(torqueTopic, torqueAdvertisedMessageType);
        //if true advertise angularVelocitytopic
        advertiseTopic(angularVelocityTopic, AngularVelocityAdvertisedMessageType);
        //publishDataMessage(torqueValue, torque);
        //publishDataMessage(angularVelocityVal, )
